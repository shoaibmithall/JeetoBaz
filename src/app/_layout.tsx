  ...
  return (
    ...
    <>
      ...
      >
        ...
        <Tabs.Screen name="my-activity" options={{ href: null }} />
        <Tabs.Screen name="recently-viewed" options={{ href: null }} />
        ...
        <Tabs.Screen name="draw-lobby/[productId]" options={{ href: null }} />
        <Tabs.Screen
          name="+not-found"
          options={{ href: null }}
        />
