...
const styles = StyleSheet.create({
  ...
  adBannerCard: { marginHorizontal: 15, marginTop: 8, borderRadius: 18, borderWidth: 1, aspectRatio: 16 / 6, overflow: 'hidden', position: 'relative' },
  adBannerCardCompact: {},
  ...
  searchRow: { flexDirection: 'row', paddingHorizontal: 12, paddingTop: 12, paddingBottom: 6, gap: 10, backgroundColor: '#04140e' },
  ...
  productName: { fontSize: 20, fontWeight: 'bold', color: 'white', flex: 1, lineHeight: 26 },
  productNameCompact: { fontSize: 14, lineHeight: 18, minHeight: 36 },
  heartBtn: { fontSize: 24, marginLeft: 10 },
  description: { fontSize: 13, color: '#aaa', marginBottom: 10, lineHeight: 19 },
