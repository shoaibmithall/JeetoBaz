...
export default function PrivacyScreen() {
  ...
  const filteredFaqs = useMemo(() => {
    ...
    if (!search) return PRIVACY_FAQS;
    return PRIVACY_FAQS.filter(
      (item) =>
...
const styles = StyleSheet.create({
  ...
  deletionBox: { borderWidth: 1, borderRadius: 12, padding: 18, marginHorizontal: 15, marginTop: 15 },
